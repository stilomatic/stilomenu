package it.quidcom.behavior
{
	...
	import it.quidcom.menu.buttons.CardAssetItem;
	...
	public class DragFrictionBehavior extends DragBehavior
	{
		...
		override public function set target(_menu:InteractiveObject):void {
			var target:CardAssetItem = CardAssetItem(_menu);
        ...
        override public function mouseDownHandler(evt:MouseEvent):void{
        	    var target:CardAssetItem = CardAssetItem(evt.currentTarget);
                target.startDrag ();
       ...
       override public function refresh(evt:MouseEvent):void {
       	    var extra = evt.currentTarget.extra;
